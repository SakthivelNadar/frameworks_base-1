...
public class QSFooterImpl extends FrameLayout implements QSFooter,
    ...
    private void setBuildText() {
        ...
        String text = Settings.System.getStringForUser(mContext.getContentResolver(),
                        Settings.System.ATOM_FOOTER_TEXT_STRING,
                        UserHandle.USER_CURRENT);
        if (isShow) {
        if (text == null || text == "") {
                v.setText("#StayAtomic");
    ...
    protected void onAttachedToWindow() {
        ...
        mContext.getContentResolver().registerContentObserver(
                Settings.System.getUriFor(Settings.System.ATOM_FOOTER_TEXT_SHOW), false,
                mSettingsObserver, UserHandle.USER_ALL);
        mContext.getContentResolver().registerContentObserver(
                Settings.System.getUriFor(Settings.System.ATOM_FOOTER_TEXT_STRING), false,
                mSettingsObserver, UserHandle.USER_ALL);
    }
    ...
    public boolean onLongClick(View v) {
        if (v == mSettingsButton) {
            startAncientSettingsActivity();
            vibrateheader();
        }
        return false;
    }

    private void startAncientSettingsActivity() {
        Intent nIntent = new Intent(Intent.ACTION_MAIN);
        nIntent.setClassName("com.android.settings",
            "com.android.settings.Settings$AtomSettingsActivity");
